...
class Square(base.Base):
    ...
    def __init__(self, name):
        ...
        self._add_output(self.Output.RESULT, desc="A Tensor or SparseTensor. Has the same type as x")

        self._add_param(self.Params.NAME, desc="Operation square", value=name, important=False)
